                                ...
                                <div class="row align-items-end">
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="button cart-button">
                                            <a href="{{ route('show-cart') }}" class="btn pt-2" style="width: 100%;">Add to Cart</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        <div class="single-block">
                            <div class="reviews">
                                ...
                                <div class="single-review">
                                    <img src="{{ asset('assets/images/blog/comment1.jpg') }}" alt="#">
                                ...
                                <div class="single-review">
                                    <img src="{{ asset('assets/images/blog/comment2.jpg') }}" alt="#">
                                    <div class="review-info">
                                ...
                                <div class="single-review">
                                    <img src="{{ asset('assets/images/blog/comment3.jpg') }}" alt="#">
                                    <div class="review-info">
