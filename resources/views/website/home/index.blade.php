            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/01.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/02.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/03.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                ...
                <div class="col-lg-4 col-md-4 col-12 custom-responsive-margin">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/04.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/05.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/06.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/07.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/08.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
                    ...
                    <div class="single-list">
                        <div class="list-image">
                            <a href="product-grids.html"><img
                                    src="{{ asset('assets/images/home-product-list/09.jpg') }}" alt="#"></a>
                        </div>
                        <div class="list-info">
                            <h3>
